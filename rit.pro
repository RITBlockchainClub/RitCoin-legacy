...
TARGET = rit-qt
VERSION = 1.0.0.0
INCLUDEPATH += src src/json src/qt src/leveldb/include src/leveldb/helpers
...
SOURCES += src/qt/bitcoin.cpp src/qt/bitcoingui.cpp \
    ...
    src/base/merkletransaction.cpp \
...
#TSQM.output = src/qt/locale/${QMAKE_FILE_BASE}.qm
...
macx:ICON = src/qt/res/icons/rit.icns
macx:TARGET = "rit-Qt"

ICON:src/qt/res/icons/rit.icns
