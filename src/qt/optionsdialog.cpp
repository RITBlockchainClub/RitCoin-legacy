        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start rit on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start rit after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the rit client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show rit addresses in the transaction list"));
